...
import { list, del, copy, reportDownload } from '@/api/report/report.js'
...
const columns = [
	...
	// 	render: (row) => {
	// 		return (
	// 			<BtnIcon color="#2969FF" disabled={!row.is_pcap} type="info" onClick={() => downloadReport(row)}>
